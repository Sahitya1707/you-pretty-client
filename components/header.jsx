        ...
        <div className="flex-initial">
          <div className="flex justify-end items-center relative">
            <div className="flex mr-4 items-center">
              <div className=" py-2 px-4 bg-blue-700 hover:bg-blue-800  rounded-lg text-white text-sm cursor-pointer flex items-center justify-center mx-1">
            ...
            <div className="block">
              <div className="inline relative">
                <button
                  type="button"
                  className=" relative px-1  rounded-medeium "
                >
